...
\title{{\LARGE Social Media influence on Open Source Software Projects}}
\subtitle{{\large INF5780 Project 2 -- Autumn 2014}}
\date{\today}
...
subscribers.
%The site does not itself host multimedia content,but users provide links with interesting content from sites like YouTube\footnote{\texttt{http://www.youtube.com}}, Imgur\footnote{\texttt{http://www.imgur.com}} and SoundCloud\footnote{\texttt{http://www.soundcloud.com}}.
